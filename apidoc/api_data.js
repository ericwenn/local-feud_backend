define({ "api": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "Date",
            "optional": false,
            "field": "messages.timesent",
            "description": "<p>Date when the message was posted</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "version": "0.0.0",
    "filename": "src/endpoints/comments/single.php",
    "groupTitle": "Comment",
    "name": "DeleteCommentsId",
    "sampleRequest": [
      {
        "url": "http://api-local.ericwenn.se/comments/:id/"
      }
    ],
    "error": {
      "examples": [
